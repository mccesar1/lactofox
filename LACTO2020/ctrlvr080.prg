...
PROCEDURE RV1068
PARAMETER xCDIAS
Dimension xVACAS(20),xDETEC(20),nVACAS(20),xCARGA(20),xINSEM(20)
xVACAS=0
xDETEC=0
...
** ------------------------------*
		If FPAR+xCDIAS<DATE()-231
			xVACAS(1)=IIF(UCAL<DATE()-231 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(1),xVACAS(1)+1)
		...
		If FPAR+xCDIAS<DATE()-210
			xVACAS(2)=IIF(UCAL<DATE()-210 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(2),xVACAS(2)+1)
		...
		If FPAR+xCDIAS<DATE()-189
			xVACAS(3)=IIF(UCAL<DATE()-189 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(3),xVACAS(3)+1)
		...
		If FPAR+xCDIAS<DATE()-168
			xVACAS(4)=IIF(UCAL<DATE()-168 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(4),xVACAS(4)+1)
		...
		If FPAR+xCDIAS<DATE()-147
			xVACAS(5)=IIF(UCAL<DATE()-147 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(5),xVACAS(5)+1)
		...
		If FPAR+xCDIAS<DATE()-126
			xVACAS(6)=IIF(UCAL<DATE()-126 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(6),xVACAS(6)+1)
		...
		If FPAR+xCDIAS<DATE()-105
			xVACAS(7)=IIF(UCAL<DATE()-105 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(7),xVACAS(7)+1)
		...
		If FPAR+xCDIAS<DATE()-84
			xVACAS(8)=IIF(UCAL<DATE()-84 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(8),xVACAS(8)+1)
		...
		If FPAR+xCDIAS<DATE()-63
			xVACAS(9)=IIF(UCAL<DATE()-63 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(9),xVACAS(9)+1)
		...
		If FPAR+xCDIAS<DATE()-42
			xVACAS(10)=IIF(UCAL<DATE()-42 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(10),xVACAS(10)+1)
		...
		If FPAR+xCDIAS<DATE()-21 
			xVACAS(11)=IIF(UCAL<DATE()-42 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(11),xVACAS(11)+1)
		...
		If FPAR+xCDIAS<DATE() 
			xVACAS(12)=IIF(UCAL<DATE()-21 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(12),xVACAS(12)+1)

			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xDETEC(12)=IIF(FECHA>=DATE()-21 And FECHA<DATE() And (CLAVE=4 Or CLAVE=5),xDETEC(12)+1,xDETEC(12))
			EndScan
			Endif
			Select REG
		Endif
...
SCAN
		If FPAR+Q5<DATE()-231 
			nVACAS(1)=IIF(UCAL<DATE()-231 And (STAT='INSEM' Or STAT='CARGA'),nVACAS(1),nVACAS(1)+1)

			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xINSEM(1)=IIF(FECHA2>=DATE()-252 And FECHA2<=DATE()-231 And CLAVE=5 And SER>0,xINSEM(1)+1,xINSEM(1))
				xCARGA(1)=IIF(FECHA2>=DATE()-252 And FECHA2<=DATE()-231 And CLAVE=6 And STAT='CARGA' And SER>0,xCARGA(1)+1,xCARGA(1))
			EndScan
			Endif
			Select REG
		Endif
		...
		If FPAR+Q5<DATE()-210 
			nVACAS(2)=IIF(UCAL<DATE()-210 And (STAT='INSEM' Or STAT='CARGA'),nVACAS(2),nVACAS(2)+1)
			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xINSEM(2)=IIF(FECHA2>=DATE()-231 And FECHA2<=DATE()-210 And CLAVE=5 And STAT='INSEM' And SER>0,xINSEM(2)+1,xINSEM(2))
				xCARGA(2)=IIF(FECHA2>=DATE()-231 And FECHA2<=DATE()-210 And CLAVE=6 And STAT='CARGA' And SER>0,xCARGA(2)+1,xCARGA(2))
			EndScan
			Endif
			Select REG
		Endif
		...
		If FPAR+Q5<DATE()-189 
			nVACAS(3)=IIF(UCAL<DATE()-189 And (STAT='INSEM' Or STAT='CARGA'),nVACAS(3),nVACAS(3)+1)
			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xINSEM(3)=IIF(FECHA2>=DATE()-210 And FECHA2<=DATE()-189 And CLAVE=5 And SER>0,xINSEM(3)+1,xINSEM(3))
				xCARGA(3)=IIF(FECHA2>=DATE()-210 And FECHA2<=DATE()-189 And CLAVE=6 And STAT='CARGA' And SER>0,xCARGA(3)+1,xCARGA(3))
			EndScan
			Endif
			Select REG
		Endif
		...
		If FPAR+Q5<DATE()-168
			nVACAS(4)=IIF(UCAL<DATE()-168 And (STAT='INSEM' Or STAT='CARGA'),nVACAS(4),nVACAS(4)+1)
			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xINSEM(4)=IIF(FECHA2>=DATE()-189 And FECHA2<=DATE()-168 And CLAVE=5 And SER>0,xINSEM(4)+1,xINSEM(4))
				xCARGA(4)=IIF(FECHA2>=DATE()-189 And FECHA2<=DATE()-168 And CLAVE=6 And STAT='CARGA' And SER>0,xCARGA(4)+1,xCARGA(4))
			EndScan
			Endif
			Select REG
		Endif
		...
		If FPAR+Q5<DATE()-147
			nVACAS(5)=IIF(UCAL<DATE()-147 And (STAT='INSEM' Or STAT='CARGA'),nVACAS(5),nVACAS(5)+1)
			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xINSEM(5)=IIF(FECHA2>=DATE()-168 And FECHA2<=DATE()-147 And CLAVE=5 And SER>0,xINSEM(5)+1,xINSEM(5))
				xCARGA(5)=IIF(FECHA2>=DATE()-168 And FECHA2<=DATE()-147 And CLAVE=6 And STAT='CARGA' And SER>0,xCARGA(5)+1,xCARGA(5))
			EndScan
			Endif
			Select REG
		Endif
		...
		If FPAR+Q5<DATE()-126
			nVACAS(6)=IIF(UCAL<DATE()-126 And (STAT='INSEM' Or STAT='CARGA'),nVACAS(6),nVACAS(6)+1)
			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xINSEM(6)=IIF(FECHA2>=DATE()-147 And FECHA2<=DATE()-126 And CLAVE=5 And SER>0,xINSEM(6)+1,xINSEM(6))
				xCARGA(6)=IIF(FECHA2>=DATE()-147 And FECHA2<=DATE()-126 And CLAVE=6 And STAT='CARGA' And SER>0,xCARGA(6)+1,xCARGA(6))
			EndScan
			Endif
			Select REG
		Endif
		...
		If FPAR+Q5<DATE()-105
			nVACAS(7)=IIF(UCAL<DATE()-105 And (STAT='INSEM' Or STAT='CARGA'),nVACAS(7),nVACAS(7)+1)
			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xINSEM(7)=IIF(FECHA2>=DATE()-126 And FECHA2<=DATE()-105 And CLAVE=5 And SER>0,xINSEM(7)+1,xINSEM(7))
				xCARGA(7)=IIF(FECHA2>=DATE()-126 And FECHA2<=DATE()-105 And CLAVE=6 And STAT='CARGA' And SER>0,xCARGA(7)+1,xCARGA(7))
			EndScan
			Endif
			Select REG
		Endif
		...
		If FPAR+Q5<DATE()-84
			nVACAS(8)=IIF(UCAL<DATE()-84 And (STAT='INSEM' Or STAT='CARGA'),nVACAS(8),nVACAS(8)+1)
			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xINSEM(8)=IIF(FECHA2>=DATE()-105 And FECHA2<=DATE()-84 And CLAVE=5 And SER>0,xINSEM(8)+1,xINSEM(8))
				xCARGA(8)=IIF(FECHA2>=DATE()-105 And FECHA2<=DATE()-84 And CLAVE=6 And STAT='CARGA' And SER>0,xCARGA(8)+1,xCARGA(8))
			EndScan
			Endif
			Select REG
		Endif
		...
		If FPAR+Q5<DATE()-63
			nVACAS(9)=IIF(UCAL<DATE()-63 And (STAT='INSEM' Or STAT='CARGA'),nVACAS(9),nVACAS(9)+1)
			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xINSEM(9)=IIF(FECHA2>=DATE()-84 And FECHA2<=DATE()-63 And CLAVE=5 And SER>0,xINSEM(9)+1,xINSEM(9))
				xCARGA(9)=IIF(FECHA2>=DATE()-84 And FECHA2<=DATE()-63 And CLAVE=6 And STAT='CARGA' And SER>0,xCARGA(9)+1,xCARGA(9))
			EndScan
			Endif
			Select REG
		Endif
		...
		If FPAR+Q5<DATE()-42 
			nVACAS(10)=IIF(UCAL<DATE()-42 And (STAT='INSEM' Or STAT='CARGA'),nVACAS(10),nVACAS(10)+1)
			Select CALOR
			If Seek(REG.ID)
			Scan While CALOR.ID=REG.ID 
				xINSEM(10)=IIF(FECHA2>=DATE()-63 And FECHA2<=DATE()-42 And CLAVE=5 And SER>0,xINSEM(10)+1,xINSEM(10))
				xCARGA(10)=IIF(FECHA2>=DATE()-63 And FECHA2<=DATE()-42 And CLAVE=6 And STAT='CARGA' And SER>0,xCARGA(10)+1,xCARGA(10))
			EndScan
			Endif
			Select REG
		Endif
		...
		xINSEM(15)=xINSEM(1)+xINSEM(2)+xINSEM(3)+xINSEM(4)+xINSEM(5)+xINSEM(6)+xINSEM(7)+xINSEM(8)+xINSEM(9)+xINSEM(10)+xINSEM(11)+xINSEM(12)

ENDSCAN
Set Filter To

*Browse
Create Cursor REPORTE (Concepto c(20),COL1 c(5),COL2 c(5),COL3 c(5),COL4 c(5),COL5 c(5),COL6 c(5),COL7 c(5),COL8 c(5))
Append Blank
Replace CONCEPTO With DTOC(DATE()-252),COL1 With Str(xVACAS(1),4),COL2 With Str(xDETEC(1),4),COL3 With Str(xDETEC(1)/xVACAS(1)*100,3),COL4 With Str(nVACAS(1),4),COL5 With Str(xINSEM(1),4),COL6 With Str(xCARGA(1),4),COL7 With Str(xCARGA(1)/xINSEM(1)*100,3),COL8 With Str(xCARGA(1)/nVACAS(1)*100,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-231),COL1 With Str(xVACAS(2),4),COL2 With Str(xDETEC(2),4),COL3 With Str(xDETEC(2)/xVACAS(2)*100,3),COL4 With Str(nVACAS(2),4),COL5 With Str(xINSEM(2),4),COL6 With Str(xCARGA(2),4),COL7 With Str(xCARGA(2)/xINSEM(2)*100,3),COL8 With Str(xCARGA(2)/nVACAS(2)*100,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-210),COL1 With Str(xVACAS(3),4),COL2 With Str(xDETEC(3),4),COL3 With Str(xDETEC(3)/xVACAS(3)*100,3),COL4 With Str(nVACAS(3),4),COL5 With Str(xINSEM(3),4),COL6 With Str(xCARGA(3),4),COL7 With Str(xCARGA(3)/xINSEM(3)*100,3),COL8 With Str(xCARGA(3)/nVACAS(3)*100,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-189),COL1 With Str(xVACAS(4),4),COL2 With Str(xDETEC(4),4),COL3 With Str(xDETEC(4)/xVACAS(4)*100,3),COL4 With Str(nVACAS(4),4),COL5 With Str(xINSEM(4),4),COL6 With Str(xCARGA(4),4),COL7 With Str(xCARGA(4)/xINSEM(4)*100,3),COL8 With Str(xCARGA(4)/nVACAS(4)*100,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-168),COL1 With Str(xVACAS(5),4),COL2 With Str(xDETEC(5),4),COL3 With Str(xDETEC(5)/xVACAS(5)*100,3),COL4 With Str(nVACAS(5),4),COL5 With Str(xINSEM(5),4),COL6 With Str(xCARGA(5),4),COL7 With Str(xCARGA(5)/xINSEM(5)*100,3),COL8 With Str(xCARGA(5)/nVACAS(5)*100,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-147),COL1 With Str(xVACAS(6),4),COL2 With Str(xDETEC(6),4),COL3 With Str(xDETEC(6)/xVACAS(6)*100,3),COL4 With Str(nVACAS(6),4),COL5 With Str(xINSEM(6),4),COL6 With Str(xCARGA(6),4),COL7 With Str(xCARGA(6)/xINSEM(6)*100,3),COL8 With Str(xCARGA(6)/nVACAS(6)*100,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-126),COL1 With Str(xVACAS(7),4),COL2 With Str(xDETEC(7),4),COL3 With Str(xDETEC(7)/xVACAS(7)*100,3),COL4 With Str(nVACAS(7),4),COL5 With Str(xINSEM(7),4),COL6 With Str(xCARGA(7),4),COL7 With Str(xCARGA(7)/xINSEM(7)*100,3),COL8 With Str(xCARGA(7)/nVACAS(7)*100,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-105),COL1 With Str(xVACAS(8),4),COL2 With Str(xDETEC(8),4),COL3 With Str(xDETEC(8)/xVACAS(8)*100,3),COL4 With Str(nVACAS(8),4),COL5 With Str(xINSEM(8),4),COL6 With Str(xCARGA(8),4),COL7 With Str(xCARGA(8)/xINSEM(8)*100,3),COL8 With Str(xCARGA(8)/nVACAS(8)*100,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-84),COL1 With Str(xVACAS(9),4),COL2 With Str(xDETEC(9),4),COL3 With Str(xDETEC(9)/xVACAS(9)*100,3),COL4 With Str(nVACAS(9),4),COL5 With Str(xINSEM(9),4),COL6 With Str(xCARGA(9),4),COL7 With Str(xCARGA(9)/xINSEM(9)*100,3),COL8 With Str(xCARGA(9)/nVACAS(9)*100,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-63),COL1 With Str(xVACAS(10),4),COL2 With Str(xDETEC(10),4),COL3 With Str(xDETEC(10)/xVACAS(10)*100,3),COL4 With Str(nVACAS(10),4),COL5 With Str(xINSEM(10),4),COL6 With Str(xCARGA(10),4),COL7 With Str(xCARGA(10)/xINSEM(10)*100,3),COL8 With Str(xCARGA(10)/nVACAS(10)*100,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-42),COL1 With Str(xVACAS(11),4),COL2 With Str(xDETEC(11),4),COL3 With Str(xDETEC(11)/xVACAS(11)*100,3),COL4 With Str(nVACAS(11),4),COL5 With Str(xINSEM(11),4),COL6 With Str(xCARGA(11),4),COL7 With Str(0,3),COL8 With Str(0,3)
Append Blank
Replace CONCEPTO With DTOC(DATE()-21),COL1 With Str(xVACAS(12),4),COL2 With Str(xDETEC(12),4),COL3 With Str(xDETEC(12)/xVACAS(12)*100,3),COL4 With Str(nVACAS(12),4),COL5 With Str(xINSEM(12),4),COL6 With Str(xCARGA(12),4),COL7 With Str(0,3),COL8 With Str(0,3)
Append Blank
Append Blank
Replace CONCEPTO With 'Total',COL1 With Str(xVACAS(15),5),COL2 With Str(xDETEC(15),4),COL3 With IIF(xDETEC(15)>0,Str(xDETEC(15)/xVACAS(15)*100,3),'  0'),COL4 With Str(nVACAS(15),5),COL5 With Str(xINSEM(15),4),COL6 With Str(xCARGA(15),4),COL7 With IIF(nVACAS(15)>0,Str(xCARGA(15)/xINSEM(15)*100,3),'  0'),COL8 With IIF(nVACAS(15)>0,Str(xCARGA(15)/nVACAS(15)*100,3),'  0')
*Browse
...
Append Blank
Replace CONCEPTO With 'Enero'     ,COL1 With Str(XS(1),3),COL2 With Str(TI(1),5,1),COL3 With Str(XS(2),3),COL4 With Str(TG(1),5,1)
Append Blank
Replace CONCEPTO With 'Febrero'   ,COL1 With Str(XS(3),3),COL2 With Str(TI(2),5,1),COL3 With Str(XS(4),3),COL4 With Str(TG(2),5,1)
Append Blank
Replace CONCEPTO With 'Marzo'     ,COL1 With Str(XS(5),3),COL2 With Str(TI(3),5,1),COL3 With Str(XS(6),3),COL4 With Str(TG(3),5,1)
Append Blank
Replace CONCEPTO With 'Abril'     ,COL1 With Str(XS(7),3),COL2 With Str(TI(4),5,1),COL3 With Str(XS(8),3),COL4 With Str(TG(4),5,1)
Append Blank
Replace CONCEPTO With 'Mayo'      ,COL1 With Str(XS(9),3),COL2 With Str(TI(5),5,1),COL3 With Str(XS(10),3),COL4 With Str(TG(5),5,1)
Append Blank
Replace CONCEPTO With 'Junio'     ,COL1 With Str(XS(11),3),COL2 With Str(TI(6),5,1),COL3 With Str(XS(12),3),COL4 With Str(TG(6),5,1)
Append Blank
Replace CONCEPTO With 'Julio'     ,COL1 With Str(XS(13),3),COL2 With Str(TI(7),5,1),COL3 With Str(XS(14),3),COL4 With Str(TG(7),5,1)
Append Blank
Replace CONCEPTO With 'Agosto'    ,COL1 With Str(XS(15),3),COL2 With Str(TI(8),5,1),COL3 With Str(XS(16),3),COL4 With Str(TG(8),5,1)
Append Blank
Replace CONCEPTO With 'Septiembre',COL1 With Str(XS(17),3),COL2 With Str(TI(9),5,1),COL3 With Str(XS(18),3),COL4 With Str(TG(9),5,1)
Append Blank
Replace CONCEPTO With 'Octubre'   ,COL1 With Str(XS(19),3),COL2 With Str(TI(10),5,1),COL3 With Str(XS(20),3),COL4 With Str(TG(10),5,1)
Append Blank
Replace CONCEPTO With 'Noviembre' ,COL1 With Str(XS(21),3),COL2 With Str(TI(11),5,1),COL3 With Str(XS(22),3),COL4 With Str(TG(11),5,1)
Append Blank
Replace CONCEPTO With 'Diciembre' ,COL1 With Str(XS(23),3),COL2 With Str(TI(12),5,1),COL3 With Str(XS(24),3),COL4 With Str(TG(12),5,1)
Append Blank
			...
			if fsec=B
				a1(1)=a1(1)+1
					...
					if stat=[CARGA] and fsec=B
						a1(5)=a1(5)+1
					endi
					if stat#[INSEM] and stat#[CARGA] and date()-fpar>30
						a1(6)=a1(6)+1	
					endi		
