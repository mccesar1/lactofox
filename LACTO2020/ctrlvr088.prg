...
*			xVACAS(1)=IIF(UCAL<=DATE()-231 And (STAT='INSEM' Or STAT='CARGA'),xVACAS(1),xVACAS(1)+1)
		...
		If FPAR+xCDIAS<=DATE()-21 
			xVACAS(11)=IIF(UCAL<DATE()-42 And STAT='CARGA',xVACAS(11),xVACAS(11)+1)
		...
		If FPAR+xCDIAS<=DATE() 
			xVACAS(12)=IIF(UCAL<DATE()-21 And STAT='CARGA',xVACAS(12),xVACAS(12)+1)
...
SELECT CALOR
SET ORDER TO 2
SET FILTER TO FECHA2>=CTOD(FREPS.CB1.Value) AND FECHA2<=CTOD(FREPS.CB2.Value) AND SER>0 AND (CLAVE=5 OR CLAVE=6)
