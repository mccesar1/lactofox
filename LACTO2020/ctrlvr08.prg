...
*-----------
*PRIVATE xnm,xnt
DIMENSION XS(30),TG(14),TI(14),MES(12)
xs=0
TG=0
TI=0
mes=1
...
Append Blank
Replace CONCEPTO With 'Total - Promedio',COL1 With Str(XS(25),5),COL2 With IIF(TI(13)>0,Str(TI(13)/xnt,5,1),'0.0'),COL3 With Str(XS(26),5),COL4 With IIF(TG(14)>0,Str(TG(14)/xnt,5,1),'0.0')
...
xTOTAL=(TI(1)+TI(2)+TI(3)+TI(4)+TI(5)+TI(6)+TI(7)+TI(8)+TI(9)+TI(10)+TI(11)+TI(12))
...
Replace CONCEPTO With ''
Append Blank
*Replace CONCEPTO With 'Total     ',COL1 With Str(XS(51),4),COL2 With Str(XS(52),4),COL3 With Str(XS(53),4),COL4 With Str(XS(50),4),COL5 With IIF(XS(50)>0,Str(XS(50)/TV/xnt,5,1),'0.0')
Replace CONCEPTO With 'Total - Promedio',COL1 With Str(XS(51),4),COL2 With Str(XS(52),4),COL3 With Str(XS(53),4),COL4 With Str(XS(50),4),COL5 With STR(xTOTAL/xnt,5,1)
...
CASE NP>0 
	...
	** -------------------------
	if stat=[INSEM] .or. stat=[CARGA] 
		repl fps with ucal+(Q39-Q35),fpp with ucal+Q39
		xx=month(fpp)
		xy=month(fps)
...
Append Blank
Replace CONCEPTO With "Actual",COL5 With Str(tpro,4),COL6 With Str(tsec,4),COL7 With Str(tpro+tsec,4),COL8 With Str(tpro/(tpro+tsec)*100,5,1)
...
Append Blank
Replace CONCEPTO With 'Total      ',COL1 With Str(xtot,4),COL2 With '100.0'
Append Blank
...
Append Blank
Replace CONCEPTO With 'Total     ',COL1 With Str(xtot2,4),COL2 With '100.0'
Append Blank
...
APPEND BLANK
APPEND BLANK
REPLACE CONCEPTO WITH 'Relacion'
APPEND BLANK
Replace Concepto WITH 'Crianza/Vientres',COL1 WITH '',COL2 WITH STR(xTOT2/xTOT*100,5,1)
...
SET ORDER TO 2
SET FILTER TO FB2=B
CALCULATE CNT() TO xTOTAL

SET FILTER TO STAT='CARGA' AND FB2=B
...
dw(2)=(cw(2)+cw(3))
dw(3)=(cw(2)+cw(3)+cw(4))
dw(4)=(cw(2)+cw(3)+cw(4)+cw(5))
dw(5)=(cw(2)+cw(3)+cw(4)+cw(5)+cw(6))
dw(6)=(cw(2)+cw(3)+cw(4)+cw(5)+cw(6)+cw(7))
dw(7)=(cw(2)+cw(3)+cw(4)+cw(5)+cw(6)+cw(7)+cw(8))
dw(8)=(cw(2)+cw(3)+cw(4)+cw(5)+cw(6)+cw(7)+cw(8)+cw(9))
dw(9)=(cw(2)+cw(3)+cw(4)+cw(5)+cw(6)+cw(7)+cw(8)+cw(9)+cw(10))
dw(10)=(cw(2)+cw(3)+cw(4)+cw(5)+cw(6)+cw(7)+cw(8)+cw(9)+cw(10)+cw(11))
dw(11)=(cw(2)+cw(3)+cw(4)+cw(5)+cw(6)+cw(7)+cw(8)+cw(9)+cw(10)+cw(11)+cw(12))
dw(12)=(cw(2)+cw(3)+cw(4)+cw(5)+cw(6)+cw(7)+cw(8)+cw(9)+cw(10)+cw(11)+cw(12)+cw(13))

Create Cursor REPORTE (Concepto c(20),COL1 c(5),COL2 c(5),COL3 c(5),COL4 c(5),COL5 c(5),COL6 c(5),COL7 c(5))
Append Blank
Replace CONCEPTO With '  0 -  60',COL1 With Str(aw(2),4),COL2 With Str(cw(2),4),COL3 With Str(aw(15),5,1),COL4 WITH STR((dw(1)/cw(38))*100,5,1),COL5 WITH STR(aw(2)/cw(2),4,2),COL6 WITH STR((cw(2)/xtotal)*100,4,1),COL7 WITH STR((dw(1)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With ' 61 -  80',COL1 With Str(aw(3),4),COL2 With Str(cw(3),4),COL3 With Str(aw(17),5,1),COL4 WITH STR((dw(2)/cw(38))*100,5,1),COL5 WITH STR(aw(3)/cw(3),4,2),COL6 WITH STR((cw(3)/xtotal)*100,4,1),COL7 WITH STR((dw(2)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With ' 81 - 100',COL1 With Str(aw(4),4),COL2 With Str(cw(4),4),COL3 With Str(aw(19),5,1),COL4 WITH STR((dw(3)/cw(38))*100,5,1),COL5 WITH STR(aw(4)/cw(4),4,2),COL6 WITH STR((cw(4)/xtotal)*100,4,1),COL7 WITH STR((dw(3)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With '101 - 120',COL1 With Str(aw(5),4),COL2 With Str(cw(5),4),COL3 With Str(aw(21),5,1),COL4 WITH STR((dw(4)/cw(38))*100,5,1),COL5 WITH STR(aw(5)/cw(5),4,2),COL6 WITH STR((cw(5)/xtotal)*100,4,1),COL7 WITH STR((dw(4)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With '121 - 150',COL1 With Str(aw(6),4),COL2 With Str(cw(6),4),COL3 With Str(aw(23),5,1),COL4 WITH STR((dw(5)/cw(38))*100,5,1),COL5 WITH STR(aw(6)/cw(6),4,2),COL6 WITH STR((cw(6)/xtotal)*100,4,1),COL7 WITH STR((dw(5)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With '151 - 180',COL1 With Str(aw(7),4),COL2 With Str(cw(7),4),COL3 With Str(aw(25),5,1),COL4 WITH STR((dw(6)/cw(38))*100,5,1),COL5 WITH STR(aw(7)/cw(7),4,2),COL6 WITH STR((cw(7)/xtotal)*100,4,1),COL7 WITH STR((dw(6)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With '181 - 210',COL1 With Str(aw(8),4),COL2 With Str(cw(8),4),COL3 With Str(aw(27),5,1),COL4 WITH STR((dw(7)/cw(38))*100,5,1),COL5 WITH STR(aw(8)/cw(8),4,2),COL6 WITH STR((cw(8)/xtotal)*100,4,1),COL7 WITH STR((dw(7)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With '211 - 240',COL1 With Str(aw(9),4),COL2 With Str(cw(9),4),COL3 With Str(aw(29),5,1),COL4 WITH STR((dw(8)/cw(38))*100,5,1),COL5 WITH STR(aw(9)/cw(9),4,2),COL6 WITH STR((cw(9)/xtotal)*100,4,1),COL7 WITH STR((dw(8)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With '241 - 270',COL1 With Str(aw(10),4),COL2 With Str(cw(10),4),COL3 With Str(aw(31),5,1),COL4 WITH STR((dw(9)/cw(38))*100,5,1),COL5 WITH STR(aw(10)/cw(10),4,2),COL6 WITH STR((cw(10)/xtotal)*100,4,1),COL7 WITH STR((dw(9)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With '271 - 300',COL1 With Str(aw(11),4),COL2 With Str(cw(11),4),COL3 With Str(aw(33),5,1),COL4 WITH STR((dw(10)/cw(38))*100,5,1),COL5 WITH STR(aw(11)/cw(11),4,2),COL6 WITH STR((cw(11)/xtotal)*100,4,1),COL7 WITH STR((dw(10)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With '301 - 330',COL1 With Str(aw(12),4),COL2 With Str(cw(12),4),COL3 With Str(aw(35),5,1),COL4 WITH STR((dw(11)/cw(38))*100,5,1),COL5 WITH STR(aw(12)/cw(12),4,2),COL6 WITH STR((cw(12)/xtotal)*100,4,1),COL7 WITH STR((dw(11)/xTOTAL)*100,4,1)
Append Blank
Replace CONCEPTO With '331  - > ',COL1 With Str(aw(13),4),COL2 With Str(cw(13),4),COL3 With Str(aw(37),5,1),COL4 WITH STR((dw(12)/cw(38))*100,5,1),COL5 WITH STR(aw(13)/cw(13),4,2),COL6 WITH STR((cw(13)/xtotal)*100,4,1),COL7 WITH STR((dw(12)/xTOTAL)*100,4,1)
Append Blank
Append Blank
Replace CONCEPTO With 'Total',COL1 With Str(aw(1),4),COL2 With Str(cw(38),4),COL3 With Str(aw(40),5,1),COL5 WITH STR(aw(1)/cw(38),4,2),COL6 WITH STR((cw(38)/xTOTAL)*100,4,1)

Release All Like aw,cw,dw,xTOTAL
