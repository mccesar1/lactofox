...
Else
	...
	** --------------
	...
	create table ALPROTEM (ID n(5),IDE c(5),CORR n(2),PSV n(1),FNAC d(8),FPAR d(8),;
		...
		sele 3
			seek xid
				if not found() and REG.fb2=B 
					ww=   "DN990001003120080500030000302000300033080003040640100030003508000300036020"+chr(13)+CHR(10)
...
if ALP.c2#REG.IDC2 and REG.idc2#0
	...
	ww=ww+"VN990001"+RIGHT("00000"+ALLTRIM(STR(XID)),5)+RIGHT("00000"+ALLTRIM(STR(REG.idc2)),4)
	ww=ww+chr(13)+chr(10)
	=FWRITE(SALIDA,ww)
	ww = ""
endif
